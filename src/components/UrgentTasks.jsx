  ...
  return (
    <div className='p-8 h-[800px] w-[500px] bg-[#13315C] flex flex-col space-x-4 rounded-lg'>
        ...
        <div className='flex flex-col space-y-4'>
            <UrgentTaskCard infoTask={0} profilePhoto={profilePhoto} setNotTasks={setNotTasks}/>
            <UrgentTaskCard infoTask={1} profilePhoto={profilePhoto} setNotTasks={setNotTasks}/>
            <UrgentTaskCard infoTask={2} profilePhoto={profilePhoto} setNotTasks={setNotTasks}/>
            <UrgentTaskCard infoTask={3} profilePhoto={profilePhoto} setNotTasks={setNotTasks}/>
            <UrgentTaskCard infoTask={4} profilePhoto={profilePhoto} setNotTasks={setNotTasks}/>
            <UrgentTaskCard infoTask={5} profilePhoto={profilePhoto} setNotTasks={setNotTasks}/>
